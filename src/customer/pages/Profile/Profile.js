...
import SearchProfileFormC from './SearchProfileFormC/SearchProfileFormC';
import ProfileListC from './ProfileListC/ProfileListC';
    ...
    return (
        <div className={cx('profile-management')}>
            ...
            {loading ? (
                ...
                <ProfileListC profiles={profiles} total={total} page={page} offset={offset} setPage={setPage} />
            )}
        </div>
    );
};
