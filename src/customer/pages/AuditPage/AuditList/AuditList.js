...
import AuditListDetail from '../AuditListDetail/AuditListDetail';

const cx = classNames.bind(styles);

const AuditList = ({ profiles, total, page, offset, setPage }) => {
    ...
    return (
        <div className={cx('profileList')}>
            ...
            {showProfileFileList && selectedProfile && (
                <AuditListDetail selectedProfile={selectedProfile} fileList={fileList} onClose={handleCloseProfileFileList} />
            )}
        </div>
    );
};
